...
class WomenItemsAdapter(
    context: Context,
    addItemsListeners: AddToCartListener,
    onItemClickListener: OnItemClickListener
) :
    RecyclerView.Adapter<WomenItemsAdapter.ViewHolder>() {
    private var womenItemList: ArrayList<CardModel>? = null
    ...
    fun setWomenItemsList(womenItems: ArrayList<CardModel>) {
        this.womenItemList = womenItems
    }
    ...
    override fun getItemCount(): Int {
        return if (womenItemList == null) {
            0
        } else {
            return womenItemList!!.size
        }
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val item = womenItemList!![position]
